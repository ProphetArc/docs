...
![Node Radius](../.gitbook/assets/wayzone_radius.png)
...
![Node Radius Menu](../.gitbook/assets/setradius_menu.png)
...
![Autopath Distance Menu](../.gitbook/assets/autopath_distance_menu.png)
...
![Bidirectional Path](../.gitbook/assets/bidirectional_path.png)
...
![Outgoing Path](../.gitbook/assets/outgoing_path.png)
...
![Incoming Path](../.gitbook/assets/incoming_path.png)
...
![Jump Connection](../.gitbook/assets/jump_connection.png)
...
![Selected Node](../.gitbook/assets/selected_point.png)
...
![Deleted Outgoing Path](../.gitbook/assets/deleted_outgoing_path.png)

Select **4. Delete path** again to delete the incoming path connection.

![Fully Deleted Path](../.gitbook/assets/fully_deleted_path.png)
...
![Path Directions Menu](../.gitbook/assets/path_directions_menu.png)
...
![Node Flags Menu](../.gitbook/assets/node_flags_menu.png)
